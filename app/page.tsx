  ...
  return <>
    ...
    <header className="main-header"><div className="wide header-inner">
      ...
      <nav className={open ? 'nav open' : 'nav'} aria-label="Primary navigation">
        ...
        <div className="nav-dropdown"><button>About us</button><div className="dropdown-menu">{aboutLinks.map((link) => <a href={`#${link.toLowerCase().replaceAll(' ', '-').replaceAll(',', '')}`} key={link}>{link}</a>)}</div></div>
